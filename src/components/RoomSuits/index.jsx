...
const RoomSuits = () => {
  ...
  return (
    <section id="roomandsuits" onMouseMove={handleMouseMove}>
      ...
      <h1 className="font-anglecia font-normal text-[56px] text-dark text-center pb-4">
        Rooms & Suits{" "}
      </h1>
      <p className="font-roboto font-normal text-lg text-dark text-center pb-5 max-w-[730px] mx-auto">
        Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
        cubilia Curae; Suspendisse sollicitudin velit sed leo. Ut pharetra augue
        nec augue. Nam elit agna, endrerit sit amet.
      </p>
      <div className="content relative text-center">
        ...
        <div className="info_box absolute top-1/2 -translate-y-1/2 w-full text-center">
          ...
          >
            <div className="info">
              <h3 className="font-anglecia font-medium text-6xl text-white text-center pb-8">
                Superior Single Room
              </h3>
              <p className="font-roboto font-normal text-lg text-white text-center pb-10 max-w-[620px] mx-auto">
                {" "}
                Donec porta diam eu massa. Quisque diam lorem, interdum vitae,
                dapibus ac, scelerisque vitae, pede. Donec eget tellus non erat
                lacinia fermentum. Donec in velit vel ipsum auctor pulvinar.
                Vestibulum iaculis lacinia est.
              </p>
              <div className="btn text-center">
                <a
                  className="font-roboto text-lg hover:bg-btn font-normal text-white bg-btn py-3 tracking-[1px] uppercase px-4 w-36 ml-2 text-center inline-block"
                  href="#"
                >
                  Book Now
                </a>
                <a
                  className="font-roboto text-lg font-normal text-white bg-[#866C56] tracking-[1px] uppercase py-3 px-4 w-36 ml-4 text-center inline-block"
                  href="#"
                >
                  Details
                </a>
